...
The application helps users manage job applications, track application status, search companies and update application information from a simple dashboard.
...
- Handles invalid requests through the backend
...
- Application data is automatically mapped between Java objects and database tables

## Frontend

- HTML5 is used to create the user interface
- CSS3 is used for basic styling
...
Java Developer | Spring Boot | MySQL | REST API